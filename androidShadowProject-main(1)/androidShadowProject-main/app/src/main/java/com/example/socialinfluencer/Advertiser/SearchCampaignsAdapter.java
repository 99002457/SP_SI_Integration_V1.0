...
import com.example.socialinfluencer.Campaign.Campaign_Data_Model;
...
public class SearchCampaignsAdapter extends FirebaseRecyclerAdapter<Campaign_Data_Model,SearchCampaignsAdapter.MyViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull MyViewHolder holder, final int position, @NonNull Campaign_Data_Model model) {
