...
public class customAdapter extends RecyclerView.Adapter<com.example.socialinfluencer.Advertiser.customAdapter.MyViewHolder>{
    ...
    Context context;
        ...
        @NonNull
        @Override
        public com.example.socialinfluencer.Advertiser.customAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull com.example.socialinfluencer.Advertiser.customAdapter.MyViewHolder holder, int position) {
